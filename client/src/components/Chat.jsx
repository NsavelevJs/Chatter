...
const Chat = ({ location }) => {
  ...
  return (
    ...
    //     {/* <!-- HEADING --> */}
    //     <div
    //       class="top-0 overscroll-none fixed w-full bg-green-400 h-16 pt-2 text-white flex justify-between shadow-md"
    //     >
    //       {/* <!-- back button --> */}
    //       <a href="#">
    //         <svg
    ...
    //       <div class="clearfix">
    //         <div
    //           class="bg-pink-300 float-right w-3/4 mx-4 my-2 p-2 rounded-lg clearfix"
    ...
    //   {/* <!-- MESSAGE INPUT AREA --> */}
    //   <div class="fixed w-full flex justify-between bg-green-100 bottom-0">
    //     <input
    //       class="outline-none flex-grow m-2 py-2 px-4 mr-1 rounded-full border border-gray-300 bg-gray-200 resize-none"
    //       rows="1"
    //       placeholder="Message..."
    //     />
